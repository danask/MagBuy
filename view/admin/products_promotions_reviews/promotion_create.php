...
<div class="page">
    <form action="../../../controller/admin/products_promotions_reviews/new_product_promotion_controller.php"
          method="post">
        Percent<input type="number" name="percent" placeholder="%"><br>
        Start<input type="datetime-local" name="start_date" placeholder="Start Date"><br>
        End<input type="datetime-local" name="end_date" placeholder="End Date"><br>
